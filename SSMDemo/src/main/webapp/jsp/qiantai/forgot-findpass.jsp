	...
	<body>
		...
		<div class="container">
			<div class="row margin-top-30">
				<div class="col-md-12 padding-left padding-right text-center margin-tb-55">
					<img src="images/login/succ_03.png"/>
					<span class="font-family tishiTxt">恭喜您，找回密码！</span>
					<div id="tishi-p">
						<p>系统将在30秒内自动跳转至 中国木擦大数据首页 ...</p>
						<p>您可以点击进入【中国木材大数据首页】</p>
					</div>
				</div>
			</div>
		</div>
