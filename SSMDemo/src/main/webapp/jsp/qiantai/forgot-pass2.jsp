...
<head>
    ...
    <script>
      ...
      function a() {
          ...
          alert(key)
          if(key==null){
              location.href="${pageContext.request.contextPath}/IFrontUser/selectus"
          }
      }
    </script>
</head>
...
<div class="container logoDiv">
    <div class="row">
        <div class="col-sm-4 col-md-4 padding-left">
            <input id="ke" type="hidden" value="${key}">
...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-1 border1 margin-top-15 regNoticeDiv">
            ...
            <form action="${pageContext.request.contextPath}/IFrontUser/UpdatePwd3">


                <p><span>输入新密码：</span>
                    <input type="hidden" name="s_uid" value="${uli.s_uid}">
                    <input type="password" required name="s_upwd"/>
                </p>
